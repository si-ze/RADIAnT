...
#unsplit_fq = 'M:/tmp/emma/fastq/EW_RADICL_S0_R1_001_ACTTGA.fastq.gz'
unsplit_fq = arg_list$unsplit
#unsplit_fq = "M:/tmp/emma/other_runs/fastq"

#rna_fastq = 'M:/tmp/emma/split_molecules/EW_RADICL_S0_R1_001_ACTTGA_RNA.fastq'
rna_fastq = arg_list$rnafastq
#rna_fastq = "M:/tmp/emma/other_runs/fastq/AB_MAY24-3_PC9_p15_RNA.fastq"

#depleted_rna_fastq = 'M:/tmp/emma/split_molecules/EW_RADICL_S0_R1_001_ACTTGA_RNA_depleted.fastq'
depleted_rna_fastq = arg_list$deplrnafastq
#depleted_rna_fastq = "M:/tmp/emma/other_runs/RADIAnT_out/fastq/AB_MAY24-3_PC9_p15_RNA_depleted.fastq"

#dna_fastq = 'M:/tmp/emma/split_molecules/EW_RADICL_S0_R1_001_ACTTGA_DNA.fastq'
dna_fastq = arg_list$dnafastq
#dna_fastq = "M:/tmp/emma/other_runs/fastq/AB_MAY24-3_PC9_p15_DNA.fastq"

#rna_star_log = 'M:/tmp/emma/RADIAnT_out/bam/EW_RADICL_S0_R1_001_ACTTGA_RNA_Log.final.out'
rna_star_log = arg_list$rnalog
#rna_star_log = "M:/tmp/emma/other_runs/RADIAnT_out/bam/AB_MAY24-3_PC9_p15_RNA_Log.final.out"

#dna_star_log = 'M:/tmp/emma/RADIAnT_out/bam/EW_RADICL_S0_R1_001_ACTTGA_DNA_Log.final.out'
dna_star_log = arg_list$dnalog
#dna_star_log = "M:/tmp/emma/other_runs/RADIAnT_out/bam/AB_MAY24-3_PC9_p15_DNA_Log.final.out"

#rna_gene_unique_intersect = 'M:/tmp/emma/RADIAnT_out/intersects/EW_RADICL_S0_R1_001_ACTTGA_RNA_gene_intersect.txt'
rna_gene_unique_intersect = arg_list$rnauniqueintersect
#rna_gene_unique_intersect = "M:/tmp/emma/other_runs/RADIAnT_out/intersects/AB_MAY24-3_PC9_p15_RNA_gene_intersect.txt"

#rna_gene_multi_intersect = 'M:/tmp/emma/RADIAnT_out/intersects/EW_RADICL_S0_R1_001_ACTTGA_RNA_multi_gene_intersect.txt'
rna_gene_multi_intersect = arg_list$rnamultiintersect
#rna_gene_multi_intersect = "M:/tmp/emma/other_runs/RADIAnT_out/intersects/AB_MAY24-3_PC9_p15_RNA_multi_gene_intersect.txt"

#dna_bin_unique_intersect = 'M:/tmp/emma/RADIAnT_out/intersects/EW_RADICL_S0_R1_001_ACTTGA_DNA_bin_intersect_maximums_cut.txt'
dna_bin_unique_intersect = arg_list$dnaintersect
#dna_bin_unique_intersect = "M:/tmp/emma/other_runs/RADIAnT_out/intersects/AB_MAY24-3_PC9_p15_DNA_bin_intersect_maximums_cut.txt"

#valid_pairs = 'M:/tmp/emma/RADIAnT_out/merge/EW_RADICL_S0_R1_001_ACTTGA_RNA-bin_pairs.txt'
valid_pairs = arg_list$pairs
#valid_pairs = "M:/tmp/emma/other_runs/RADIAnT_out/merge/AB_MAY24-3_PC9_p15_RNA-bin_pairs.txt"

#radiant_interactions = 'M:/tmp/emma/RADIAnT_out/interactions/EW_RADICL_S0_R1_001_ACTTGA_RADIAnT_results.txt'
radiant_interactions = arg_list$radiant
#radiant_interactions = "M:/tmp/emma/other_runs/RADIAnT_out/interactions/AB_MAY24-3_PC9_p15_RADIAnT_results.txt"

output = arg_list$output
#output = "M:/tmp/emma/other_runs/RADIAnT_out/logs/AB_MAY24-3_PC9_p15_"
